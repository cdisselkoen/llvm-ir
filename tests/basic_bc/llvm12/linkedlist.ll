...
define dso_local i32 @simple_linked_list(i32 %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define dso_local i32 @indirectly_recursive_type(i32 %0) #0 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define dso_local i32 @takes_opaque_struct(%struct.SomeOpaqueStruct* %0) #0 {
