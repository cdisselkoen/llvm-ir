...
; <label>:3:                                      ; preds = %0
  invoke void @__cxa_throw(i8* %1, i8* bitcast (i8** @_ZTISt11logic_error to i8*), i8* bitcast (void (%"class.std::logic_error"*)* @_ZNSt11logic_errorD1Ev to i8*)) #5
...
; <label>:4:                                      ; preds = %0
  ...
  tail call void @__cxa_free_exception(i8* %1) #4
  br label %12
...
; <label>:12:                                     ; preds = %8, %4
  %13 = phi i32 [ %11, %8 ], [ %7, %4 ]
  %14 = phi i8* [ %10, %8 ], [ %6, %4 ]
  %15 = tail call i32 @llvm.eh.typeid.for(i8* bitcast (i8** @_ZTISt11logic_error to i8*)) #4
  %16 = icmp eq i32 %13, %15
  br i1 %16, label %17, label %20

; <label>:17:                                     ; preds = %12
  %18 = tail call i8* @__cxa_begin_catch(i8* %14) #4
...
attributes #0 = { norecurse sspstrong uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="4" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
