...
define noundef i32 @main() local_unnamed_addr #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = tail call i8* @__cxa_allocate_exception(i64 16) #5
  %2 = bitcast i8* %1 to %"class.std::logic_error"*
  invoke void @_ZNSt11logic_errorC1EPKc(%"class.std::logic_error"* noundef nonnull align 8 dereferenceable(16) %2, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0))
...
13:                                               ; preds = %8
  ...
  %16 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* noundef %15)
...
declare void @_ZNSt11logic_errorC1EPKc(%"class.std::logic_error"* noundef nonnull align 8 dereferenceable(16), i8* noundef) unnamed_addr #1
...
declare void @_ZNSt11logic_errorD1Ev(%"class.std::logic_error"* noundef nonnull align 8 dereferenceable(16)) unnamed_addr #2
