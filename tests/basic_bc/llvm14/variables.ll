...
define void @variables(i32 noundef %0, i32* noundef %1) local_unnamed_addr #0 {
  ...
  %6 = tail call dereferenceable_or_null(4) i8* @malloc(i64 noundef 4) #3
  %7 = bitcast i8* %6 to i32*
  %8 = load volatile i32, i32* %4, align 4, !tbaa !5
  %9 = add nsw i32 %8, 5
  store volatile i32 %9, i32* %4, align 4, !tbaa !5
  %10 = load volatile i32, i32* %7, align 4, !tbaa !5
  %11 = add nsw i32 %10, 5
  store volatile i32 %11, i32* %7, align 4, !tbaa !5
