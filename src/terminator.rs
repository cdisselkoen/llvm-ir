...
/// See [LLVM 11 docs on Terminator Instructions](https://releases.llvm.org/11.0.0/docs/LangRef.html#terminator-instructions)
...
/// See [LLVM 11 docs on the 'ret' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#ret-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Ret {
...
/// See [LLVM 11 docs on the 'br' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#br-instruction).
...
/// See [LLVM 11 docs on the 'switch' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#switch-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Switch {
    pub operand: Operand,
...
/// See [LLVM 11 docs on the 'indirectbr' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#indirectbr-instruction)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on the 'invoke' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#invoke-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Invoke {
...
/// See [LLVM 11 docs on the 'resume' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#resume-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Resume {
    pub operand: Operand,
    #[cfg(feature="llvm-9-or-greater")]
...
/// See [LLVM 11 docs on the 'cleanupret' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#cleanupret-instruction)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on the 'catchret' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#catchret-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct CatchRet {
...
/// See [LLVM 11 docs on the 'catchswitch' instruction](https://releases.llvm.org/11.0.0/docs/LangRef.html#catchswitch-instruction)
#[derive(PartialEq, Clone, Debug)]
