...
/// See [LLVM 13 docs on Constants](https://releases.llvm.org/13.0.0/docs/LangRef.html#constants).
/// Constants can be either values, or expressions involving other constants (see [LLVM 13 docs on Constant Expressions](https://releases.llvm.org/13.0.0/docs/LangRef.html#constant-expressions)).
...
pub enum Constant {
    ...
    Float(Float),
    /// The `TypeRef` here must be to a `PointerType`. See [LLVM 13 docs on Simple Constants](https://releases.llvm.org/13.0.0/docs/LangRef.html#simple-constants)
    Null(TypeRef),
    ...
    /// `Undef` can be used anywhere a constant is expected. See [LLVM 13 docs on Undefined Values](https://releases.llvm.org/13.0.0/docs/LangRef.html#undefined-values)
    Undef(TypeRef),
    /// See [LLVM 13 docs on Poison Values](https://releases.llvm.org/13.0.0/docs/LangRef.html#undefined-values)
    #[cfg(feature="llvm-12-or-greater")]
    Poison(TypeRef),
    /// The address of the given (non-entry) [`BasicBlock`](../struct.BasicBlock.html). See [LLVM 13 docs on Addresses of Basic Blocks](https://releases.llvm.org/13.0.0/docs/LangRef.html#addresses-of-basic-blocks).
