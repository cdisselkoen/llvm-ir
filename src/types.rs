...
/// See [LLVM 13 docs on Type System](https://releases.llvm.org/13.0.0/docs/LangRef.html#type-system)
#[derive(PartialEq, Eq, Clone, Debug, Hash)]
#[allow(non_camel_case_types)]
pub enum Type {
    /// See [LLVM 13 docs on Void Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#void-type)
    VoidType,
    /// See [LLVM 13 docs on Integer Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#integer-type)
    IntegerType { bits: u32 },
    /// See [LLVM 13 docs on Pointer Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#pointer-type)
    PointerType {
        pointee_type: TypeRef,
        addr_space: AddrSpace,
    },
    /// See [LLVM 13 docs on Floating-Point Types](https://releases.llvm.org/13.0.0/docs/LangRef.html#floating-point-types)
    FPType(FPType),
    /// See [LLVM 13 docs on Function Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#function-type)
    FuncType {
        result_type: TypeRef,
    ...
    /// which means they can be produced by instructions (see [LLVM 13 docs on First Class Types](https://releases.llvm.org/13.0.0/docs/LangRef.html#first-class-types)).
    /// See [LLVM 13 docs on Vector Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#vector-type)
    VectorType {
    ...
    /// a single instruction (see [LLVM 13 docs on Aggregate Types](https://releases.llvm.org/13.0.0/docs/LangRef.html#aggregate-types)).
    /// See [LLVM 13 docs on Array Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#array-type)
    ArrayType {
        element_type: TypeRef,
        num_elements: usize,
    },
    /// The `StructType` variant is used for a "literal" (i.e., anonymous) structure type.
    /// See [LLVM 13 docs on Structure Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#structure-type)
    StructType {
    ...
    /// See [LLVM 13 docs on X86_MMX Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#x86-mmx-type)
    X86_MMXType,
    ...
    X86_AMXType,
    /// See [LLVM 13 docs on Metadata Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#metadata-type)
    MetadataType,
    /// `LabelType` is the type of [`BasicBlock`](../struct.BasicBlock.html) labels.
    /// See [LLVM 13 docs on Label Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#label-type)
    LabelType,
    /// See [LLVM 13 docs on Token Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#token-type)
    TokenType,
}
...
pub enum NamedStructDef {
    /// An opaque struct type; see [LLVM 13 docs on Opaque Structure Types](https://releases.llvm.org/13.0.0/docs/LangRef.html#t-opaque).
    Opaque,
