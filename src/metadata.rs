//! See [LLVM 11 docs on Metadata](https://releases.llvm.org/11.0.0/docs/LangRef.html#metadata)
...
/// See [LLVM 11 docs on Metadata Nodes and Metadata Strings](https://releases.llvm.org/11.0.0/docs/LangRef.html#metadata-nodes-and-metadata-strings)
...
/// See [LLVM 11 docs on DIBasicType](https://releases.llvm.org/11.0.0/docs/LangRef.html#dibasictype)
...
/// See [LLVM 11 docs on DICompileUnit](https://releases.llvm.org/11.0.0/docs/LangRef.html#dicompileunit)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DICompositeType](https://releases.llvm.org/11.0.0/docs/LangRef.html#dicompositetype)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DIDerivedType](https://releases.llvm.org/11.0.0/docs/LangRef.html#diderivedtype)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DIEnumerator](https://releases.llvm.org/11.0.0/docs/LangRef.html#dienumerator)
#[derive(PartialEq, Eq, Clone, Debug)]
...
/// See [LLVM 11 docs on DIExpression](https://releases.llvm.org/11.0.0/docs/LangRef.html#diexpression)
pub type DIExpression = Vec<DWOp>;

/// See [LLVM 11 docs on DIFile](https://releases.llvm.org/11.0.0/docs/LangRef.html#difile)
#[derive(PartialEq, Eq, Clone, Debug)]
pub struct DIFile {
    pub filename: String,
...
/// See [LLVM 11 docs on DIGlobalVariable](https://releases.llvm.org/11.0.0/docs/LangRef.html#diglobalvariable)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DIImportedEntity](https://releases.llvm.org/11.0.0/docs/LangRef.html#diimportedentity)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DILexicalBlock](https://releases.llvm.org/11.0.0/docs/LangRef.html#dilexicalblock)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DILexicalBlockFile](https://releases.llvm.org/11.0.0/docs/LangRef.html#dilexicalblockfile)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DILocalVariable](https://releases.llvm.org/11.0.0/docs/LangRef.html#dilocalvariable)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DILocation](https://releases.llvm.org/11.0.0/docs/LangRef.html#dilocation)
#[derive(PartialEq, Clone, Debug)]
...
/// See LLVM 11 docs on [DIMacro](https://releases.llvm.org/11.0.0/docs/LangRef.html#dimacro) and
/// [DIMacroFile](https://releases.llvm.org/11.0.0/docs/LangRef.html#dimacrofile)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DINamespace](https://releases.llvm.org/11.0.0/docs/LangRef.html#dinamespace)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DIObjCProperty](https://releases.llvm.org/11.0.0/docs/LangRef.html#diobjcproperty)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DISubprogram](https://releases.llvm.org/11.0.0/docs/LangRef.html#disubprogram)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DISubrange](https://releases.llvm.org/11.0.0/docs/LangRef.html#disubrange)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 11 docs on DISubroutineType](https://releases.llvm.org/11.0.0/docs/LangRef.html#disubroutinetype)
#[derive(PartialEq, Clone, Debug)]
...
/// See LLVM 11 docs on [DITemplateTypeParameter](https://releases.llvm.org/11.0.0/docs/LangRef.html#ditemplatetypeparameter)
/// and [DITemplateValueParameter](https://releases.llvm.org/11.0.0/docs/LangRef.html#ditemplatevalueparameter)
#[derive(PartialEq, Clone, Debug)]
